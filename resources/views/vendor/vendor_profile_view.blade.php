                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ (!empty($vendorProfile->photo)) ? url('upload/vendor_images/'.$vendorProfile->photo) : url('upload/no_image.jpg')}}"
                                         alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                    <div class="mt-3">
                                        <h4>{{ $vendorProfile->username }}</h4>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('vendor.profile.store')}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control"
                                                   value="{{ $vendorProfile->username }}" disabled/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                 src="{{ (!empty($vendorProfile->photo)) ? url('upload/vendor_images/'.$vendorProfile->photo) : url('upload/no_image.jpg')}}"
                                                 alt="Vendor"
