                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="font-xs">
                                    ...
                                    <ul class="float-start">
                                        ...
                                        <li>Stock:<span class="in-stock text-brand ml-5">({{ $product->product_qty }}) Items In Stock</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="tab-content shop_info_tab entry-main-content">
                                ...
                                <div class="tab-pane fade" id="Vendor-info">
                                    <div class="vendor-logo d-flex mb-30">
                                        <img
                                            src="{{ (!empty($product->vendor->photo)) ? url('upload/vendor_images/'.$product->vendor->photo):url('upload/no_image.jpg') }}"
                                            alt=""/>
