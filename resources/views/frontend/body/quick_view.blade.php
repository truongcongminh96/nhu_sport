                        ...
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand" id="pprice" style="font-size: 40px !important;"></span>
{{--                                    <span><span class="old-price font-sm ml-15" id="oldprice"></span></span>--}}
                                </div>
                            </div>
                                    ...
                                    <div class="font-xs">
                                        <ul>
                                            ...
                                            <li class="mb-5">Stock:<span class="badge badge-pill badge-success"
                                                                         id="aviable"
                                                                         style="backgound:green; color: white;"> </span>
                                                <span class="badge badge-pill badge-danger" id="stockout"
                                                      style="backgound:red; color: white;"> </span></li>
                                        </ul>
                                    </div>
                                </div> <!-- // End col  -->
                            </div> <!-- // end row -->
